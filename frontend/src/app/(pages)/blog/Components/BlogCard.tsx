...
export const BlogCard: React.FC<{ blog: Blog; author?: boolean }> = ({ blog, author = true }) => {
  const router = useRouter();
  const handleNavigate = (blogId: string | number) => {
        ...
        {author && (
          <div className="flex items-center gap-2 mt-3">
            ...
            <div className="flex flex-col gap-1">
              <p className="text-xs jakarta font-semibold text-gray-800">
                {blog.author}
              </p>
