        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl border border-slate-100 p-6 w-full max-w-sm shadow-xl">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <h3 className="flex items-center justify-center gloock text-base md:text-lg text-[#0d1f2d] mb-1">Delete post?</h3>
                ...
                <p className="text-[13px] md:text-sm text-slate-500 mb-5 pt-1">
                    <span className="font-semibold text-slate-700">"{title}"</span> will be permanently deleted. This action cannot be undone.
                </p>
