...
const Herosection = () => {
  return (
    <div className="relative h-[95vh] lg:h-screen w-full overflow-hidden bg-[#276597]">
      {/* Content Container */}
      <div className="relative lg:-top-40 md:-top-40 sm:-top-40 -top-30 z-10 h-full flex flex-col items-center justify-center text-white px-4 md:px-8 my-10">
        <motion.h1
          initial={{ y: 200, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 2, ease: "easeOut" }}
          className="text-5xl sm:text-[60px] md:text-[130px] xl:text-[160px] font-bold mb-4 text-center tracking-wider mange bg-gradient-to-b from-[#FFFFFF] to-[#FFFFFF]/10 text-transparent bg-clip-text"
        >
          {/* Adventure */}
          Elite Escapes
        </motion.h1>
      ...
      <div>
        <Image
          ...
          alt="bgimage"
          fill
          className="z-30 xl:mt-30 md:mt-24 mt-18 md:object-cover object-contain"
        />
      </div>
      ...
      <div className="absolute -bottom-50 left-0 w-full h-full flex gap-4 z-30">
        {/* Static cloud */}
        <div className="absolute left-0  bottom-5 md:bottom-0 w-[600px] h-[500px]">
        ...
        <motion.div
          ...
          className="absolute left-0 bottom-0 w-[600px] h-[550px]"
        >
          <Image src="/images/Group 4.png" alt="Eco-conscious icon" fill />
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute right-0 -bottom-4 w-[600px] h-[550px]"
        >
