    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#dce8f0] px-4">
            <div className="w-full max-w-4xl flex flex-col">
                <div className="text-start mb-3 md:mb-5">
                    <Link href="/" className="text-[#0A5482] hover:underline flex flex-row items-center gap-1 text-base font-medium">
                        <ArrowLeft className="w-4 h-4 inline-block mr-1" />
                        <p> Back to Home</p>
                    </Link>
                </div>
                <div className="w-full flex rounded-2xl shadow-lg overflow-hidden">
                    {/* Left — Form */}
