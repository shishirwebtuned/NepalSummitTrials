    ...
    <div className="space-y-6 w-full">
      ...
      <div className="bg-white rounded-xl shadow-md lg:px-6 md:px-3 px-5 lg:py-10 md:py-8 py-9">
        ...
        <div className="flex justify-between items-center text-center text-gray-800 font-medium">
          <div>
            <p className="lg:text-xs md:text-[11px] text-[10px] text-[#939393]">
              From
            </p>
            <p className="lg:text-lg md:text-base text-base text-[#0B2839] font-bold">
              <span className="">$</span>7500
              <span className="text-[#939393] lg:text-[13px] md:text-xs text-[11px]">
                / Adult
              </span>
            </p>
          </div>
          ...
          <div>
            ...
            <p className="lg:text-lg md:text-base text-base text-[#0B2839] font-bold">
              <span className="text-black">$</span>7500
              <span className="text-[#939393] lg:text-[13px] md:text-xs text-[11px]">
                / Child
              </span>
            </p>
        ...
        <div className="mt-4 bg-[#2A78A6] text-white lg:text-sm md:text-xs text-xs rounded-b-xl lg:px-4 px-3 lg:py-3 py-[10px] text-center">
          ...
          <a href="#" className="text-[#D5E880] font-medium hover:underline">
            Send Us A Message
          </a>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-[#ACC0CC]/34 lg:px-6 md:px-3 px-5 lg:py-10 md:py-8 py-9 text-center">
        <div className="flex justify-center mb-3">
          <img
            src="/images/icons/questionIcon.svg"
            alt="Question Icon"
            className="lg:w-12 lg:h-12 md:h-10 md:w-10 w-9 h-9"
          />
        </div>
        <h4 className="lg:text-lg md:text-base text-sm font-semibold text-gray-800">
          Have a Question in mind
        </h4>
        <p className="lg:text-sm md:text-xs text-[10px] text-gray-500 mt-1 mb-4">
          Looking for more info? Send a question to the tour agent to find out
          more.
        </p>
        <button className="bg-[#0B2839] hover:bg-[#0f557d] transition text-white font-medium py-2 px-4 lg:text-base md:text-sm text-xs cursor-pointer rounded-lg">
          Send the message
        </button>
      </div>
    </div>
